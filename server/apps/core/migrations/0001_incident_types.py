    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.TextField(
                        blank=True, default="", null=True, verbose_name="Заголовок"
                    ),
                ),
                (
                    "text",
                ...
                (
                    "is_downloaded",
                    models.BooleanField(default=False, verbose_name="Скачана"),
                ),
                (
                    "is_parsed",
                ...
                (
                    "is_incident_created",
                    models.BooleanField(default=False, verbose_name="Инцидент создан"),
                ),
                (
                    "is_duplicate",
                    models.BooleanField(default=False, verbose_name="Дубликат"),
                ),
                (
                    "rate",
                    models.JSONField(default=dict, verbose_name="Оценка релевантности"),
                ),
                (
                    "create_date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "treshold",
                    models.FloatField(default=1, verbose_name="Treshold для модели"),
                ),
                (
                    "description",
                    models.CharField(
                ...
                (
                    "chat_gpt_prompt",
                    models.TextField(
                        blank=True, null=True, verbose_name="Chat-GPR промпт"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.TextField(unique=True, verbose_name="URL списка новостей"),
                ),
                (
                    "is_active",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1, verbose_name="Количество ограничений"
                    ),
                ),
                (
                    "urls",
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.URLField(blank=True, default="", null=True),
                        blank=True,
                        null=True,
                        size=None,
                    ),
                ...
                (
                    "public_description",
                    models.TextField(
                        blank=True, null=True, verbose_name="Публичное описание"
                    ),
                ),
                (
                    "assigned_to",
