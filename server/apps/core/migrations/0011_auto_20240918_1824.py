    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True, max_length=100, null=True, verbose_name="LLM модель"
            ),
        ),
        migrations.AddField(
            model_name="incidenttype",
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True,
                default="<|begin_of_text|><|start_header_id|>system<|end_header_id|>{system_prompt}<|eot_id|><|start_header_id|>user<|end_header_id|>{prompt}<|eot_id|><|start_header_id|>assistant<|end_header_id|>",
                null=True,
